classdef LeftArrow < handle
    %% This class holds the parameters required to draw a left-pointing arrow
    ...
    methods
        ...
        function obj = LeftArrow(center, color)
            obj.center_coor = center; %1 by 2 array
            obj.color = color; %1 by 3 array
        end
